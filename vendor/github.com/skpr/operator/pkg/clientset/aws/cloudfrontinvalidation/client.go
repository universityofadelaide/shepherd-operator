...
const Kind = "CloudFrontInvalidation"

// Interface declares interactions with the CloudFrontInvalidation objects.
type Interface interface {
	List(opts metav1.ListOptions) (*awsv1beta1.CloudFrontInvalidationList, error)
	Get(name string, opts metav1.GetOptions) (*awsv1beta1.CloudFrontInvalidation, error)
	...
	Update(*awsv1beta1.CloudFrontInvalidation) (*awsv1beta1.CloudFrontInvalidation, error)
	Delete(name string, opts *metav1.DeleteOptions) error
	Watch(opts metav1.ListOptions) (watch.Interface, error)
}

// Client for interacting with CloudFrontInvalidation objects.
type Client struct {
