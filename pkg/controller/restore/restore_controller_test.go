...
func TestReconcile(t *testing.T) {
	...
	instance := &extensionv1.Restore{ObjectMeta: metav1.ObjectMeta{Name: "foo", Namespace: "default"}}
	...
	// Create the Restore object and expect the Reconcile and Deployment to be created
