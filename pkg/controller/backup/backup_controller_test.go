...
func TestReconcile(t *testing.T) {
	...
	instance := &extensionv1.Backup{ObjectMeta: metav1.ObjectMeta{Name: "foo", Namespace: "default"}}
	...
	// Create the Backup object and expect the Reconcile and Deployment to be created
