...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	c, err := controller.New("backupscheduled-controller", mgr, controller.Options{Reconciler: r})
	if err != nil {
		return err
	}
	...
	// Uncomment watch a Deployment created by BackupScheduled - change this for objects you create
	err = c.Watch(&source.Kind{Type: &appsv1.Deployment{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &extensionv1.BackupScheduled{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileBackupScheduled) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	// Fetch the BackupScheduled instance
